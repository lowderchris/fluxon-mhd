...
preffile = 'dat/frtest-lowres/frtest-rlx'    # flux world file [.flux]
prewfile = 'dat/frtest-lowres/frtest-rlx'     # fluxon wind file [.dat]

# Define the world frame to plot
rlx = 1200
...
# Annotate
if anno: mlab.text(0.01,0.01,'%05.f'%rlx,opacity=0.5,width=0.07)

# Save the figure
mlab.savefig('./plt/frm'+'%05.f'%rlx+'.png')
