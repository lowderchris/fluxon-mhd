...
package FLUX::Fluxpipe::helpers::pipe_helper;
@EXPORT_OK = qw(set_paths configurations print_banner search_files_in_directory);
...
sub configurations {
    ...
    my $config_path = catfile("fluxon-mhd", "fluxpipe", "fluxpipe", "config", $config_filename);
