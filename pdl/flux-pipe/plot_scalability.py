    ...
    for ii, line_name in enumerate(to_plot):
        ...
        if abscissa_valid.any():
            ...
            if not "Success" in line_name: 
                ...
                ax.step(abscissa_valid, this_line_valid, color=color, where="post")
