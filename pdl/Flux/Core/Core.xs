...
FLUX->stw_helper		= stw_helper;
FLUX->safe_tree_walker		= safe_tree_walker;
...
FLUX->binary_dump_header        = binary_dump_header;
FLUX->binary_dump_WORLD         = binary_dump_WORLD;
FLUX->binary_dump_CONCENTRATION = binary_dump_CONCENTRATION;
FLUX->binary_dump_FLUXON        = binary_dump_FLUXON;
FLUX->binary_dump_neighbors     = binary_dump_neighbors;
FLUX->binary_dump_end           = binary_dump_end;
FLUX->binary_dump_fluxon_pipe   = binary_dump_fluxon_pipe;
FLUX->binary_read_dumpfile      = binary_read_dumpfile;
FLUX->binary_read_fluxon_pipe   = binary_read_fluxon_pipe;
...
FLUX->gather_photosphere_neighbor_candidates= gather_photosphere_neighbor_candidates;
FLUX->photosphere_hull_neighbors= photosphere_hull_neighbors;
FLUX->photosphere_vertex_update_neighbors= photosphere_vertex_update_neighbors; 
FLUX->project_n_fill_photosphere= project_n_fill_photosphere;
FLUX->hull_2d_us_photosphere	= hull_2d_us_photosphere;
