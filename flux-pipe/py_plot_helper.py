...
def path_add(dirlist, do_print=False):
    """
    Adds the given list to the module search path.

    Parameters
    ----------
    dirlist : list of str
        List of directory paths to be added to the system path.
    do_print : bool, optional
        If True, print the paths that are being added. Default is False.
    """
