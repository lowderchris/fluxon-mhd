...
def get_magnetogram_files(cr=None, date=None, data_dir=None, email=None, do_download=False, batch='fluxon'):
    """
    ...
    if not do_download:
        try:
            ...
            if not "mag" in data_dir:
                data_dir = data_dir + f"/{batch}/{use_path}/mag/"
